        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Button asChild size="sm" variant="outline" className="rounded-full px-4">
                <Link to={ROUTES.bhw.triage}>
                  Log action
                  <MonitorDown className="size-4 ml-1" />
                </Link>
              </Button>
            </div>
          </div>
          ...
          <Card className="w-full max-w-md border-emerald-200 bg-white/90 shadow-sm backdrop-blur">
            <CardHeader className="border-b border-slate-100 pb-4">
              ...
              <CardDescription>
                Barangay-scoped metrics from Supabase.
              </CardDescription>
            </CardHeader>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <Card className="border-slate-200 bg-white/90 shadow-sm backdrop-blur">
          <CardHeader className="border-b border-slate-100 pb-4">
            ...
            <CardDescription>
              Barangay-scoped vector density alerts, breeding ground coordinates, and node battery warnings.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border-slate-200 bg-white/90 shadow-sm backdrop-blur">
          <CardHeader className="border-b border-slate-100 pb-4">
            ...
            <CardDescription>
              Triage log entries and field action statuses.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 pt-5">
            {actionLog.map((item) => (
