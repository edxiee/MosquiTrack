        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          ...
          <Card className="w-full max-w-md border-emerald-200 bg-white/90 shadow-sm backdrop-blur">
            <CardHeader className="border-b border-slate-100 pb-4">
              ...
              <CardDescription>
                Live municipality metrics from Supabase database.
              </CardDescription>
            </CardHeader>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <Card className="border-slate-200 bg-white/90 shadow-sm backdrop-blur">
          <CardHeader className="border-b border-slate-100 pb-4">
            ...
            <CardDescription>
              Municipal alert history and tier transitions.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border-slate-200 bg-white/90 shadow-sm backdrop-blur">
          <CardHeader className="border-b border-slate-100 pb-4">
            ...
            <CardDescription>
              Export metadata and municipal report generation history.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 pt-5">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Municipal vector summary exported recently.
              </p>
            </div>

            <Button asChild className="w-full justify-between rounded-full bg-emerald-600 hover:bg-emerald-700 text-white">
              <Link to={ROUTES.lgu.reports}>
                Generate report
                <ArrowRight className="size-4" />
              </Link>
