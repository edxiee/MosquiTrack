...
import { fetchDevices } from "../../nodes/services/deviceService";
import { formatDeployedBy, isDeviceActive } from "../../nodes/utils/deviceHelpers";
import type { OvitrapDevice } from "../../nodes/types/device";
...
export default function PrescriptiveAnalyticsPage() {
  ...
  const handleSubmitRequest = async (payload: {
    ...
    // TODO: save to your requests table / API
    console.log("Submitting request action:", payload);
    // Example:
    // await supabase.from("request_actions").insert({ ...payload, created_at: new Date().toISOString() });
    alert(
